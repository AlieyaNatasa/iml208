...
# make database and users (if not exists already) table at programme to start up
...
class travel:
    ...
    #Define Function
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "UiTM":
                    switch ={"Amanjaya Mall": 12,"Central Square": 13,"KTM SP":15,"UiTM": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Amanjaya Mall":
                    switch ={"Amanjaya Mall": 0,"Central Square": 6,"KTM SP":5,"UiTM": 12}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Central Square":
                    switch ={"Amanjaya Mall": 6,"Central Square": 0,"KTM SP":1,"UiTM": 13}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "KTM SP":
                    switch ={"Amanjaya Mall": 5,"Central Square": 1,"KTM SP":0,"UiTM": 15}
                    Km.set(switch[varl2.get()])        
        ...
        def Total_Paid():
            if ((var1.get() == 1 and var2.get() == 1 and var3.get() == 1 or var4.get() == 1) and carType.get() != 0 and journeyType.get() != 0 and (varl1.get() != "" and varl2.get() !="")):
                if journeyType.get()==1:
                    ...
                    Tax = "RM " + str('%.1f'%((Cost_of_fare) *0.03))
                    ST = "RM " + str('%.1f'%((Cost_of_fare)))
                    TT = "RM " + str('%.1f'%(Cost_of_fare+((Cost_of_fare)*0.2)))
                elif journeyType.get()==2:
                    Item2=Km.get()
                    Cost_of_fare = (Item1+(float(Item2)*Item5)*1.1+Item3+Item4)

                    Tax = "RM " + str('%.1f'%((Cost_of_fare) *0.06))
                    ST = "RM " + str('%.1f'%((Cost_of_fare)))
                    TT = "RM " + str('%.1f'%(Cost_of_fare+((Cost_of_fare)*0.2)))
                else:
                    Item2=Km.get()
                    ...
                    Tax = "RM " + str('%.1f'%((Cost_of_fare) *0.09))
                    ST = "RM " + str('%.1f'%((Cost_of_fare)))
                    TT = "RM " + str('%.1f'%(Cost_of_fare+((Cost_of_fare)*0.2)))
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab Information==============================================================
        ...
        self.cboPickup['value']=('','Amanjaya Mall','Central Square','KTM SP','UiTM')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Amanjaya Mall','Central Square','KTM SP','UiTM')
        self.cboDrop.current(0)
